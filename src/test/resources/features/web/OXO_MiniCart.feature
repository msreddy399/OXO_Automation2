...
Scenario: verify whether guest user added item is available in minicart 
	...
	When verify the item is add to cart 
	Then Verify below Sub/Main Module of PDP Page 
		|# Verify following elements in the Mini cart|
...
Scenario: verify the registered user added item is available in minicart 
	...
	When verify the item is add to cart 
	Then Verify below Sub/Main Module of PDP Page 
		|# Verify following elements in the Minicart |
		|minicartCheckout_Btn|
		|miniCartViewCart_Btn|
...
Scenario: Verify whether registered user is able to land on checkout page by clicking view checkout button 
	And user clicks on Sign In link in the header 
	And user enters email "email" 
	And user enters password "Password" 
	And Clicks on login button 
